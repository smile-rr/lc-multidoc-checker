        ...
        <div style={{ padding: '20px 22px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ background: '#fff', border: '1px solid var(--me-grey-15)', borderRadius: 12, padding: '18px 20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, fontSize: 13, lineHeight: 1.6, color: 'var(--me-grey)' }}>
              <div><strong style={{ color: 'var(--status-error)' }}>1. Critical — Availability / place of expiry.</strong> The credit is available with any bank, yet expiry is stated in London while shipment and presentation occur in Singapore. <span style={{ fontFamily: 'var(--font-mono)', fontSize: 11.5, color: 'var(--me-grey-70)' }}>(CHK-AVL · UCP 600 art. 6)</span></div>
              <div><strong style={{ color: '#946400' }}>2. Major — Expiry buffer.</strong> Presentation location is cross-border from the beneficiary and the expiry date leaves no courier buffer — operational risk of a late presentation. <span style={{ fontFamily: 'var(--font-mono)', fontSize: 11.5, color: 'var(--me-grey-70)' }}>(CHK-EXP · UCP 600 art. 6(d))</span></div>
