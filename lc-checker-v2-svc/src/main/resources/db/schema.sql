...
CREATE TABLE IF NOT EXISTS lc_v3.documents (
    ...
    file_sha256           CHAR(64),
    page_count            INT,
    deal_tiff_pages       JSONB,   -- 1-based page index(es) in merged deal TIFF (deal bundle only)
    doc_type_desc         TEXT,    -- officer-facing label (registry default or manifest override)
...
ALTER TABLE lc_v3.documents ADD COLUMN IF NOT EXISTS doc_type_desc TEXT;
